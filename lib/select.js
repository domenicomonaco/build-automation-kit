  ...
  fs.createReadStream(filecsv)
    ...
    .on('end', () => {
      (async () => {
        ...
        ///////////////////////////////////////////////////////////////////////////////////
        console.log(clc.bgBlueBright('> LINK /////////////////////////////////////////////'));
        ...
        console.log(clc.bgBlueBright('> ') + clc.bgBlue(info['base_previewURL'] +  process.env.BASEFOLDER));
        console.log(clc.bgBlueBright('> ') + clc.bgBlue(info['base_previewURL'] +  process.env.BASEFOLDER +'/'+ selecteduser['value']));
        console.log(clc.bgBlueBright('> ') + clc.bgBlue( info['base_previewURL'] +  process.env.BASEFOLDER +'/'+ selecteduser['value'] + '/' + reponame));
