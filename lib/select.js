        ...
        (async () => {
          ...
          function useroption(process, reponame, info, baseURL, selecteduser) {
            ...
            (async () => {
              let gitOP = await prompts([
                {
                  ...
                  choices: [
                    ...
                    { title: 'Build and run (Vue)', value: 'build_node_vue'},
                    { title: 'Open Apache (Php)', value: 'open_apache'},
              ...
              if(gitOP['value'] == 'open_apache'){
                console.log(info['base_previewURL'] + process.env.BASEFOLDER + '/' + selecteduser['value'] + '/' + reponame);
                open(info['base_previewURL'] + process.env.BASEFOLDER + '/' + selecteduser['value'] + '/' + reponame);
              }
              else if (gitOP['value'] == 'change_user') {
